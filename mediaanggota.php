...
<!DOCTYPE html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" class="col-md-12">
        <div class="wrapper">
            ...
            <?php include'menuAnggota.php'; ?>
            <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                <!-- Content Header (Page header) -->
                <!-- Main content -->
                <section class="content">
            <?php include'content_a.php'; ?>
                    </section>
                </div> 
                <!-- /.content-wrapper -->
...
<script> $(document).ready(function() { $('#dataTables2').DataTable();} );</script>
</body>
</html>
        ...
        $("#ubahpass").validate({
              ...
              messages: {
                password1: {
                  ...
                  minlength: "minimal 5 huru/angka"
                },
                password2: {
                  required: "tidak boleh kosong",
                  minlength: "minimal 5 huru/angka",
