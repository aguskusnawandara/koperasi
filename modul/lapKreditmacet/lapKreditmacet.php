<script type="text/javascript" src="modul/lapKreditmacet/ajax.js"></script>
<style type="text/css">
...
<?php 
	echo "<div id='dalam_content' align='center'>
		...
		<div id='menu-tombol'>
			...
			<br/>
			Catatan : Setelah keluar jendela baru untuk mencetak tekan tombol Ctrl+P. Format kertas Landscape
		</div>
	</div>";
?>